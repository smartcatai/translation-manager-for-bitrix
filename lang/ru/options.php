<?
$MESS["SMARTCAT_CONNECTOR_DOSTUP_K"] = "Доступ к API";
$MESS["SMARTCAT_CONNECTOR_DOPOLNITELQNYE_NASTR"] = "Дополнительные настройки";
$MESS["SMARTCAT_CONNECTOR_NE_PEREVODITQ_ELEMEN"] = "Не переводить элемент, пока не выполнен перевод всех связанных элементов";
$MESS["SMARTCAT_CONNECTOR_DLA_UVEDOMLENIY"] = "для уведомлений";
$MESS["SMARTCAT_CONNECTOR_PUTQ_K_DOPOLNITELQNO"] = "Путь к дополнительному CSS";
$MESS["SMARTCAT_CONNECTOR_VERSIA"] = "Версия коннектора: ";
$MESS["SMARTCAT_CONNECTOR_VERSIA_SHEMY"] = "Версия схемы коннектора: ";
...
$MESS["SMARTCAT_CONNECTOR_SC_ASIA"] = "Азия";
